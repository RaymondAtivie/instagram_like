...
mix.js('resources/assets/js/app.js', 'public/js/bundle.js')
    .extract(['vue', 'vuex', 'vue-router', 'vuetify', 'lodash', 'axios', 'moment']);

mix.stylus('resources/assets/stylus/entry.styl', 'public/css/vendor.css')
    .sass('node_modules/mdi/scss/materialdesignicons.scss', 'public/css/vendor-icons.css')
    .sass('resources/assets/sass/app.scss', 'public/css')
    // .extract(['vue', 'vuex', 'vue-router', 'vuetify'])
